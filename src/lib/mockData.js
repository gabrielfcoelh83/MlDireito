...
// As questões saíram daqui.
//
// Elas vêm do questoes-service (`GET /api/questoes`), alimentado com os
// cadernos e gabaritos que a própria FGV publica. Um banco de questões escrito
// à mão no front tinha dois problemas que nenhuma revisão resolve: o gabarito
// era palpite de quem digitou — duas respostas estavam erradas quando foram
// conferidas — e o acervo parava de crescer no dia em que ninguém editasse
// este arquivo.
//
// O que sobrou aqui é o que a API ainda não serve: cronograma, anotações e a
// lista de disciplinas com horas estudadas.
